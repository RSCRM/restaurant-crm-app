...
export const AuthActions = createActionGroup({
  ...
  events: {
    Init: emptyProps(),
    'Restore Auth': props<{ accessToken: string; systemRoles: string[]; contextToken: string | null; permissions: string[] }>(),
    ...
    'Select Context Success': props<{ contextToken: string; permissions: string[] }>(),
    'Select Context Failure': props<{ error: string }>(),
    'Clear Context': emptyProps(),
