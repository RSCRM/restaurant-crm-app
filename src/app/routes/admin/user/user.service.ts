...
import { PagingResponse, RoleResponse, UserCreationRequest, UserResponse, UserRolesUpdateRequest, UserSearchRequest } from './user.model';
...
export class UserService {
  ...
  getRoles(): Observable<RoleResponse[]> {
    return this.http.get<ApiResponse<any>>(this.ROLE_API).pipe(
      map(res => {
        const d = res.data;
