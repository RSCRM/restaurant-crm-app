...
describe('AttendanceService', () => {
  ...
  it('matches every attendance endpoint', () => {
    ...
    service.getEmployeeHistory(
      'employee-1', '2026-07-01', '2026-07-31', 2, 20, 'branch-1').subscribe();
    const employeeHistory = http.expectOne(request =>
      request.url === '/api/v1/erp/attendances/branch/employees/employee-1/history');
